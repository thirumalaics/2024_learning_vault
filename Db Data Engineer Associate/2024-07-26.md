- one common pattern that I noticed is that he reads tables(bronze, silver) using readStream and creates temp views on top of df and applies transformation by sourcing the temp view
